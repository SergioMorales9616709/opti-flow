...
enum SaccadicPattern {
  ...
  List<Alignment> get sequence => switch (this) {
    ...
    SaccadicPattern.crossPattern => [
      const Alignment(0, -0.95), // 1  top extreme
      const Alignment(0, 0.95), // 2  bottom extreme
      ...
      const Alignment(-0.95, 0), // 7  left extreme
      const Alignment(0.95, 0), // 8  right extreme
    ...
    SaccadicPattern.xPattern => [
      const Alignment(-0.95, -0.95), // 1  top-left extreme
      const Alignment(0.95, 0.95), // 2  bottom-right extreme
      ...
      const Alignment(0.95, -0.95), // 7  top-right extreme
      const Alignment(-0.95, 0.95), // 8  bottom-left extreme
